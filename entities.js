...
class TeleportPortal {
  ...
  draw(ctx) {
    ...
    ctx.lineWidth = 2;
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (6);
...
class Spinner {
  ...
  draw(ctx) {
    ...
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (8);
    ...
    ctx.restore();
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (0);
  }
}
...
class SuperBumper {
  ...
  draw(ctx) {
    ...
    ctx.save();
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (this.pulse > 0.05 ? 8 + this.pulse * 10 : 4);
    ctx.shadowColor = this.color;
    ctx.fillStyle = grad;
    ctx.beginPath();
...
class SlowVortex {
  ...
  draw(ctx) {
    ...
    ctx.lineWidth = 1.5;
    ctx.setLineDash([5, 8]);
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (10);
    ctx.shadowColor = this.color;
...
class SpeedPad {
  ...
  draw(ctx) {
    ...
    ctx.lineCap = 'round';
    ctx.lineJoin = 'round';
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (3);
    ctx.shadowColor = '#fff';
...
class LaunchPad {
  ...
  draw(ctx) {
    ...
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (this.pulse > 0.05 ? 6 + this.pulse * 12 : 4);
    ctx.shadowColor = this.color;
...
class Peg {
  ...
  draw(ctx) {
    ...
    if (this.pulse > 0.05) {
      ...
      ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (this.pulse * 12);
...
class SpikeTrap {
  ...
  draw(ctx) {
    ...
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (8 + danger * 10);
    ...
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (14);
    ctx.beginPath();
...
class ItemBase {
  ...
  draw(ctx) {
    ...
    ctx.translate(this.x, this.y);
    ctx.rotate(this.angle);
    ctx.shadowBlur = typeof LOW_END_MODE !== "undefined" && LOW_END_MODE ? 0 : (8 + glow * 9);
